...
export default function Tutorial(props: Props) {
	...
	return (
		<div className={cn("min-h-screen flex justify-center", "relative")}>
            ...
            <div className="absolute w-[513px] bg-[rgba(0,0,0,0.2)] h-full z-[-1] right-0 hidden md:flex">

            </div>
			<div className={cn("grid md:grid-cols-2 grid-cols-1 items-center justify-center gap-14")}>
